...
/// Phosphor icons for eClassify 2.14 screens (merge path).
///
/// Live UI still uses SVG paths from [AppIcons] in `app_icon.dart`.
/// Use [AppPhosphorIcons] in new or migrated widgets only.
abstract final class AppPhosphorIcons {
